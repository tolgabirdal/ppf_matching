                            ...
                            gdiam_point_cnt  proj )
{
    ...
    for  ( int  ind = 0; ind < 8; ind++ ) {
        ...
        for  ( int  jnd = 0; jnd < 8; jnd++ ) {
            ...
            //pnt_dump( b );
            rl = max2( rl, pnt_distance( a, b, proj ) );
        }
    }
...
public:
                ...
                gdiam_point  proj_dir, gdiam_real dist )
    {
        ...
        max_diam = max2( max2( bbox_proj_dist( _left->getBBox(),
                                        _right->getBBox(),
                                        proj_dir ),
    ...
    double  getProjectionError() const 
    {
        ...
        two_r = max2( left->maxDiam(), right->maxDiam() );
                                    ...
                                    int  sample_size )
{
    ...
    grid_size = (int)sqrt( (double)sample_size / (double)2 );
